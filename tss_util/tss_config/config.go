...
// GetConfigFromENV reads tss_config from Env variables, validates it and parses
// it into tss_config suitable for application
//
...
// GetConfigFromFile reads tss_config from file, validates it and parses
// it into tss_config suitable for application
