...
func (k *BaseFrostTss) ProcessInboundMessages(ctx context.Context, msgChan chan *comm2.WrappedMessage) (err error) {
	defer func() {
		if r := recover(); r != nil {
...
func (k *BaseFrostTss) ProcessOutboundMessages(ctx context.Context, outChn chan tss.Message, messageType comm2.MessageType) error {
