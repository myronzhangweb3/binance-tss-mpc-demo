...
func (m *MockCommunication) Broadcast(peers peer.IDSlice, msg []byte, msgType comm2.MessageType, sessionID string) error {
	m.ctrl.T.Helper()
...
func (m *MockCommunication) Subscribe(sessionID string, msgType comm2.MessageType, channel chan *comm2.WrappedMessage) comm2.SubscriptionID {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Subscribe", sessionID, msgType, channel)
	ret0, _ := ret[0].(comm2.SubscriptionID)
	return ret0
}
...
func (m *MockCommunication) UnSubscribe(subID comm2.SubscriptionID) {
	m.ctrl.T.Helper()
